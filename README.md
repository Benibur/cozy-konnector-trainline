...
This konnector retrieves your travel bills and bills data from [trainline.fr](https://www.trainline.fr)
...
The lead maintainers for this konnector is @doubleface for Cozy Cloud, with contributions from Phyks and ZeHiro.
